...
export default {
	...
	data: () => {
		return {
			experienceTitle: 'Anos de experiência',
			githubTitle: 'Seguidores',
			feedbackTitle: 'Feedback positivo',
